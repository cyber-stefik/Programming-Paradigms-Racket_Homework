...
(define (apply-functional-transformations Fs tuple)
  (foldl (λ (x tuple) (x tuple)) tuple Fs)
 )
  ...
  (λ (tuple F1 F2 F3)
    (λ (n)
      (foldl (λ (Fs x) (cond
                         ...
                         ((= Fs 1) (F1 x))
                         ((= Fs 2) (F2 x))
                         (else (F3 x)))) tuple (get-transformations n))
      )
    )
 )
...
(define get-nth-quadruple
  (get-nth-tuple '(1 1 2 3) (curry FQ1) (curry FQ2) (curry FQ3))
 )
...
(define (get-nth-ppt-from-GH-quadruples n)
  ...
  (list
        (* (list-ref myQuadruple 0) (list-ref myQuadruple 3))
        (* 2 (* (list-ref myQuadruple 1) (list-ref myQuadruple 2)))
        (+ (expt (list-ref myQuadruple 1) 2) (expt (list-ref myQuadruple 2) 2))
   )
 )
